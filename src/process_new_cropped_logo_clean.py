...
if os.path.exists(src_path):
    ...
    newData = []
    for item in datas:
        # Convert off-white and near-white pixels (value > 200) to transparent
        # This removes all compression artifacts and gray shadows around the edges
    ...
    print("Logo cleaned with threshold 200 successfully!")
else:
