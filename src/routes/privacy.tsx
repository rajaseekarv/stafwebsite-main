...
function PrivacyPage() {
  ...
  <div className="relative mx-auto max-w-5xl space-y-6 px-0 text-left text-lg leading-8 text-ink-2">
    ...
    <Reveal delay={150}>
      ...
      <p className="mt-4">
        Stafróf Intelligence Corporation ("Stafróf", "we", "our", or "us") is
        ...
        collect, use, disclose, store, and protect your information when you
        visit our website or interact with our products and services.
      </p>
    ...
    <Reveal delay={200}>
      ...
      <p className="mt-2">
        ...
        functionality, understand visitor behavior, analyze website
    ...
    <Reveal delay={255}>
      ...
      <ul className="list-disc space-y-1.5 pl-5">
        ...
        <li>
          Communicate updates, newsletters, and marketing communications
          (where permitted by law or with your consent).
        </li>
        <li>Analyze website usage and performance.</li>
        <li>
          Protect our systems against fraud, misuse, and cybersecurity
          threats.
        </li>
        <li>
    ...
    <Reveal delay={300}>
      ...
      <ul className="list-disc space-y-1.5 pl-5">
        <li>
          Authorized service providers that support our business operations.
        </li>
        ...
        <li>
          Successors in connection with a merger, acquisition, or business
          reorganization.
        </li>
      </ul>

      <p className="mt-2.5">
        All third parties are expected to protect personal information in
    ...
    <Reveal delay={350}>
      ...
      <p className="mt-2.5">
        ...
        safeguards to help protect personal information against unauthorized
        access, disclosure, alteration, loss, or destruction. While we strive
        to use commercially reasonable security measures, no method of
    ...
    <Reveal delay={400}>
      ...
      <p className="mt-2.5">
        ...
        obligations, resolve disputes, enforce agreements, and support
    ...
    <Reveal delay={450}>
      ...
      <p className="mt-2.5">
        ...
        stored in countries other than your country of residence. Where
        applicable, we implement appropriate safeguards to protect personal
        information during international data transfers.
      </p>
    ...
    <Reveal delay={600}>
      ...
      <p className="mt-2.5">
        Our website and services are intended for business and professional
        use. We do not knowingly collect personal information from
        individuals under the age required by applicable law. If we become
    ...
    <Reveal delay={750}>
      ...
      <p className="mt-2.5">
        ...
        Policy or our privacy practices, please contact Stafróf Intelligence
        Corporation using the contact information provided on our website.
      </p>
